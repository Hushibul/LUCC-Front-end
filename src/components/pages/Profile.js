...
const Profile = () => {
  ...
  if (isUpdated) {
   ...
   return (
   <section style={{padding:'0px',height:'100vh',backgroundImage: "url(" + "https://images.unsplash.com/photo-1517757910079-f57fd7f49a91?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1168&q=80" + ")" }}>
   <div  >
   <Header/>
          <div style={{ height:'200px',objectFit:"cover",backgroundImage: "url(" + "https://images.unsplash.com/photo-1517757910079-f57fd7f49a91?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1168&q=80" + ")"}}>
