...
const porfolioblock = [
    { img: img4, title: 'Tech Storm', text: 'Join us for consultatoins' },
    { img: img5, title: 'LUCC Carnival', text: 'Join us for consultatoins' },
    { img: img6, title: 'ICT Fest', text: 'Join us for consultatoins' },
